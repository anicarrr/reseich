...
import { Download, Eye, Filter, Calendar, ArrowDownLeft, History, Clock, CircleDollarSign } from 'lucide-react';
...
const TRANSACTION_STATUSES = {
  completed: { label: 'Completed', color: 'bg-[#10b981]/20 text-[#10b981] border border-[#10b981]/30' },
  pending: { label: 'Pending', color: 'bg-[#ff8a00]/20 text-[#ff8a00] border border-[#ff8a00]/30' },
  failed: { label: 'Failed', color: 'bg-[#ef4444]/20 text-[#ef4444] border border-[#ef4444]/30' },
  cancelled: { label: 'Cancelled', color: 'bg-white/20 text-gray-300 border border-white/30' }
};
...
export const TransactionHistory: React.FC<TransactionHistoryProps> = ({
  ...
  const exportTransactions = () => {
    const csvContent = [
      ['Date', 'Type', 'Description', 'Amount (SEI)', 'Credits', 'Status', 'Transaction Hash'],
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">View all your credit purchases, marketplace transactions, and research spending</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Select value={typeFilter} onValueChange={setTypeFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="research_spending">Research Spending</SelectItem>
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <div className="font-semibold text-white">{transaction.amount_sei} SEI</div>
